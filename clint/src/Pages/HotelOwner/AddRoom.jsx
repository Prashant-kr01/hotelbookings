...
const AddRoom = () => {
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler}>
      <Tittle align='left' font='outfit'  title='Add Room' subTitle='Fill in the details carefully and accurate room details, pricing, and amenities, to enhance the user booking experience.'/>
     ...
     <p className='text-gray-800 mt-4'>Amenities</p>
      ...
      <button className='bg-blue-400 text-white px-4 py-2 rounded mt-4 cursor-pointer' disabled={loading}>
