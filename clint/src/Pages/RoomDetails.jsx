...
const RoomDetails = () => {
    ...
    // onSubmitHandler function to check availability & book room
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
        ...
        <div className='flex flex-col md:flex-row gap-6 mt-6'>
          <div className='lg:w-1/2 w-full'>
            <img src={mainImage} alt="room Image" className='w-full object-cover rounded-xl shadow-lg' />
          </div>
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
         <div className='flex flex-col'>
          ...
          <div className='flex items-wrap item-center gap-4 mt-3 mb-6'>
         ...
         <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
            ...
            <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
             <div className='flex flex-col'>
              ...
              <input 
              onChange={(e)=>{setCheckOutDate(e.target.value)}} min={checkInDate} disabled={!checkInDate} type="date" id='checkOutDate' placeholder='Check-Out' className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required/>
            </div>
            <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
            <div className='flex flex-col'>
          ...
          <button type='submit' className='bg-blue-600 hover:bg-blue-400 active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>
     ...
     <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
      <p>Guests will be allocated on the ground floor according to availability. you get a comfortable Two bedroom apartment has a true city feeling. The price quoted is for two guest, at  the guest slot please mark the number of guests to get the exact price for groups. The Guests will be allocated ground floor according to availability.you get the comfortable tow bedroom apartment that has a true city feeling</p>
     </div>
    ...
    <button className='px-6 py-2.5 mt-4 rounded text-white bg-blue-600 hover:bg-blue-400 transition-all cursor-pointer '>Contact Now</button>
      </div>
