  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col items-center md:flex-row justify-between w-full'>
            <Tittle align='left' title='Exclusive Offers' subTitle='Take advantage of our limited-time offers and special pacakages to enhance your stay and create unforgettable memories.'/>
